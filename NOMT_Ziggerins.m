...
% OT Alpha
% Aug. 22, 2019 - Updated by: Jason Chow, changelog at bottom
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function NOMT_Ziggerins(subjno, experimenter, hand, dataDir)
try
    ...
    % Create datafile
    fileName = [dataDir '/' num2str(subjno) '_nomtZigg_' timestamp '.csv'];
    ...
    %% Load study Screens
    studyScreen1 = imread('Ziggerins_study1.jpg');
    studyScreen1_texture = Screen('MakeTexture', w, studyScreen1);
    
    studyScreen2 = imread('Ziggerins_study2.jpg');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Read in trial data
    trials = readtable('Ziggerins_trials.txt', 'Format', ...
        '%u %s %s %u %u %s %s %s %s');
